  ...
  const products = [
    {
      ...
      stock: 'In Stock',
      badge: 'Sterile',
      description: 'Complete set of surgical scissors'
    },
    {
      id: 'forceps-set',
      ...
      stock: 'In Stock',
      badge: 'Professional',
      description: 'Various surgical forceps for different procedures'
    },
    {
      id: 'scalpel-handles',
      ...
      stock: 'In Stock',
      badge: 'Essential',
      description: 'Reusable scalpel handles with disposable blades'
    },
    {
      id: 'surgical-retractors',
      ...
      stock: 'Low Stock',
      badge: 'Complete',
      description: 'Self-retaining and handheld retractors'
    }
  ];
      ...
      <header className="border-b border-slate-700 bg-slate-800/95 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-2xl font-bold text-blue-400">Surgical Tools</h1>
          </div>
        </div>
      </header>
        ...
        <div className="mb-8 space-y-4">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <Input
                type="text"
                placeholder="Search surgical tools..."
                value={searchTerm}
