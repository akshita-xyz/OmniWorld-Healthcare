...
const LabEquipment = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      stock: 'In Stock',
      badge: 'Professional',
      description: 'Automatic steam sterilizer for laboratory equipment'
    },
    {
      id: 'incubator-lab',
      ...
      description: 'Precision temperature controlled incubator'
    },
    {
      id: 'water-bath',
      ...
      stock: 'In Stock',
      badge: 'Digital',
      description: 'Microprocessor controlled water bath'
    }
  ];
      ...
      <header className="border-b border-slate-700 bg-slate-800/95 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-2xl font-bold text-blue-400">Lab Equipment</h1>
          </div>
        </div>
      </header>
