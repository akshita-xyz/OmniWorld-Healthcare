  ...
  const products = [
    {
      ...
      stock: 'In Stock',
      badge: 'Professional',
      description: 'Advanced 12-lead ECG machine with digital display'
    },
    {
      id: 'holter-monitor',
      ...
      stock: 'In Stock',
      badge: 'Portable',
      description: 'Continuous cardiac monitoring system'
    },
    {
      id: 'patient-monitor',
      ...
      stock: 'Low Stock',
      badge: 'Advanced',
      description: 'Complete patient monitoring system'
    },
    {
      id: 'fetal-monitor',
      ...
      stock: 'In Stock',
      badge: 'Specialized',
      description: 'Non-invasive fetal monitoring device'
    }
  ];
      ...
      <header className="border-b border-slate-700 bg-slate-800/95 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-2xl font-bold text-blue-400">Monitoring Devices</h1>
          </div>
        </div>
      </header>
        ...
        <div className="mb-8 space-y-4">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <Input
                type="text"
                placeholder="Search monitoring devices..."
                value={searchTerm}
