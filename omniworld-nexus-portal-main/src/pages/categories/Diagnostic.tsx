  ...
  const products = [
    {
      ...
      stock: 'In Stock',
      badge: 'Professional',
      description: 'High-quality otoscope with LED illumination'
    },
    {
      id: 'ophthalmoscope-1',
      name: 'Digital Ophthalmoscope',
      price: 28500,
      rating: 4.9,
      reviews: 89,
      stock: 'In Stock',
      badge: 'Advanced',
      description: 'Digital ophthalmoscope with image capture'
    },
    {
      id: 'reflex-hammer',
      name: 'Neurological Reflex Hammer',
      price: 2500,
      rating: 4.6,
      reviews: 203,
      stock: 'In Stock',
      badge: 'Essential',
      description: 'Precision reflex hammer for neurological tests'
    },
    {
      id: 'tuning-fork',
      ...
      stock: 'Low Stock',
      badge: 'Set',
      description: 'Complete set of medical tuning forks'
    }
  ];
      ...
      <header className="border-b border-slate-700 bg-slate-800/95 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-2xl font-bold text-blue-400">Diagnostic Tools</h1>
          </div>
        </div>
      </header>
        ...
        <div className="mb-8 space-y-4">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <Input
                type="text"
                placeholder="Search diagnostic tools..."
                value={searchTerm}
