...
const PPE = () => {
  ...
  const products = [
    {
      id: 'n95-masks',
      name: 'N95 Respirator Masks (Pack of 20)',
      price: 2500,
      rating: 4.8,
      reviews: 456,
      stock: 'In Stock',
    ...
    },
    {
      ...
      stock: 'In Stock',
      badge: 'Anti-Fog',
      description: 'Disposable face shields with anti-fog coating'
    },
    {
      id: 'isolation-gowns',
      ...
      stock: 'Low Stock',
      badge: 'Level 2',
      description: 'Level 2 isolation gowns for medical use'
    }
  ];
      ...
      <header className="border-b border-slate-700 bg-slate-800/95 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-2xl font-bold text-blue-400">Personal Protective Equipment</h1>
          </div>
        </div>
      </header>
        ...
        <div className="mb-8 space-y-4">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <Input
                type="text"
                placeholder="Search PPE equipment..."
                value={searchTerm}
